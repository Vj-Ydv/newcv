...
class ProjectItem(models.Model):
    resume = models.ForeignKey("curriculum.Resume", related_name='projects',on_delete=models.CASCADE)
    project = models.ForeignKey("curriculum.Project", related_name='items',on_delete=models.CASCADE)
