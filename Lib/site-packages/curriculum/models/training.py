...
class Training(models.Model):
    resume = models.ForeignKey("curriculum.Resume", related_name='trainings',on_delete=models.CASCADE)
    ...
    month = models.IntegerField(choices=MONTHS, verbose_name=_("month"))
