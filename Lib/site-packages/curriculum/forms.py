...
class ResumeExportForm(forms.Form):
    ...
    hide_twitter = forms.BooleanField(required=False)
    hide_linkedin = forms.BooleanField(required=False)
    ...
    hide_project_contribution = forms.BooleanField(required=False)
