      ...
      {% if projects %}
        ...
        <table>
          ...
          <td style="text-align: right">
            {% if not hide_project_url and project.project.url %}<small><a href="{{ project.project.url }}">{{ project.project.url }}</a></small>{% endif %}
          </td>
          </tr>
        </table>
        {% if not hide_project_contribution and project.contribution %}
